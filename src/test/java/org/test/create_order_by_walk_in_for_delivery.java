...
import org.kona.pageobjectclass.*;
import com.aventstack.extentreports.ExtentReports;
import com.aventstack.extentreports.ExtentTest;
import com.aventstack.extentreports.Status;
import com.aventstack.extentreports.reporter.ExtentHtmlReporter;

public class create_order_by_walk_in_for_delivery extends BaseClass {
	...
	private void select_order_type() throws IOException, InterruptedException {
		...
		Order_management_module order_management = PageFactory.initElements(driver, Order_management_module.class);
		String walkin_for_deliver_order_type = order_management.walkin_for_deliver_order_type();
		extentTest.log(Status.INFO, "Actual Result is -" + walkin_for_deliver_order_type);
		extentTest.log(Status.INFO, "Expected Result is -" + getPropertyValue("address_label"));
		extentTest.log(Status.INFO, "Verification of Actual & Expected Validation");
		if (walkin_for_deliver_order_type.equals(getPropertyValue("address_label"))) {
			extentTest.log(Status.PASS, "Actual & Expected Validation are Equal");
		} else {
			extentTest.log(Status.FAIL, "Actual & Expected Validation are Not are Equal");
			ScreenShots("create_order.png");
	...
	private void address_for_delivery_service() throws IOException, InterruptedException, AWTException {
		...
		Order_management_module order_management = PageFactory.initElements(driver, Order_management_module.class);
		String wfd_address_for_delivery = order_management.wfd_address_for_delivery();
		extentTest.log(Status.INFO, "Actual Result is -" + wfd_address_for_delivery);
		extentTest.log(Status.INFO, "Expected Result is -" + getPropertyValue("walkin_delivery"));
		extentTest.log(Status.INFO, "Verification of Actual & Expected Validation");
		if (wfd_address_for_delivery.equals(getPropertyValue("walkin_delivery"))) {
			extentTest.log(Status.PASS, "Actual & Expected Validation are Equal");
		} else {
			extentTest.log(Status.FAIL, "Actual & Expected Validation are Not are Equal");
			ScreenShots("create_order.png");
